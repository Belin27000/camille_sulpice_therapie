    ...
    return (
        <div className='about'>
            ...
            <ul className='about-list'>
                <li className='about-list-item'>Formation de formateurs / Ingénierie de formation - 2020 Attribut conseils</li>
                <li className='about-list-item'>ADVP et la démarche éducative expérientielle en orientation - 2020 Le patio formation</li>
                <li className='about-list-item'>Clinicien de la relation Niveau fondement - 2022-2023 LACT</li>
                <li className='about-list-item'>Palo Alto dans le monde médical : Pathologies et douleurs chroniques 2023 Nathalie Goujon</li>
